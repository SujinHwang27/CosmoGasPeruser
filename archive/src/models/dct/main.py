...
save_path = "data/processed/Sherwood_z0.3_inf/dct_full"
run_name = "z0.3_inf_dct_full"
...
if __name__ == "__main__":
    with mlflow.start_run(run_name=run_name) as run:
        ...
        save_processed_data(X_dct, y, save_path)

        # 3. Plot and log artifact
        # plot_path_list = plot_dct_by_los(X_dct, y, save_path=save_path, title="DCT_Comparison", n_classes=4)
        # for plot_path in plot_path_list:
        #     mlflow.log_artifact(plot_path, artifact_path="plots")
        mlflow.log_artifact(save_path, artifact_path="transformed_data")
